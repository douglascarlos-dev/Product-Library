...
<form action="<?php echo URLROOT; ?>/products/update/<?php echo $products->getStockKeepingUnit(); ?>" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
      <label for="inputSkux">Marca</label>
      <input type="text" class="form-control" id="inputSkux" name="skux" value="" maxlength="100" readonly>
    </div>
    <div class="form-group col-md-9">
      <label for="inputSkux">Categoria</label>
      <input type="text" class="form-control" id="inputDescricaox" name="descricaox" value="" maxlength="100" readonly>
      </div>
    </div>
...
?>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            <label for="inputSku">Nome do arquivo <?php if($photo_value->getSequence() == 1){ ?><i title="Foto principal!" class="fa-solid fa-flag" style="color: #FFD43B;"></i><?php } ?></label>
...
?>
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            <label for="inputSku">URL do Vídeo MP4 <i id="copyButton" class="fa-solid fa-copy"></i></label>
            <input type="text" class="form-control" id="urlVideo" name="urlVideo" value="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?><?php echo URLROOT; ?>/video/<?php echo $video_value->getFileName(); ?>" maxlength="100" readonly>
        </div>
    </div>
...
<footer class="pt-3 my-md-2">
      <div class="row">
        <div class="col-12 col-md">
          <small class="d-block mb-3 text-muted text-center">© 2024<br><a href="https://github.com/douglascarlos-dev/Product-Library" target="_blank"><img src="<?php echo URLROOT; ?>/img/logo.svg" alt="HTML tutorial" style="height:35px;"></a></small>
        </div>
      </div>
    </footer>
</div>
